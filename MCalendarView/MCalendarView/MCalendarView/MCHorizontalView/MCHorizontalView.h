...
@interface MCHorizontalView : UIView
...
@property (nonatomic, copy) BOOL (^MCHorizontalViewCanTouchBlock)(MCalendarHandleStyle style, MCDayModel * day);
/**
 * 单选模式 :
 ...
 */
@property (nonatomic, copy) void (^MCHorizontalViewTouchBlock)(MCalendarHandleStyle style, MCDayModel * startDay, MCDayModel * endDay);
